  ...
  return (
    <div className="profile-page">
      ...
      <p className="profile-hint">
        People who've messaged you for the first time show up here. Accept to unlock unlimited
        messaging with them — decline and they won't be able to message you again.
      </p>
